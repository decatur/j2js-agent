...
public interface KTableModel {
    ...
    /**
     * Returns the number of columns and rows spanned by this cell. The returned value must be
     * consistent with the values returned by {@link KTableModel#belongsToCell(int, int)}.
     */
    Point getCellSpan(int col, int row);
     ...
     * Note that the total number of fixed columns is the sum of header and selectable fixed columns.
